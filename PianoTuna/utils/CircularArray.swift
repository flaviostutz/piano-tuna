...
//  See his original work at https://github.com/mauriciosantos/Buckets-Swift/blob/master/Source/CircularArray.swift
//
import Foundation
...
public struct CircularArray<T> {
    ...
    public mutating func removeAll(keepingCapacity keep: Bool = false)  {
        if !keep {
            items = [T?](repeating: nil, count: Constants.DefaultCapacity)
