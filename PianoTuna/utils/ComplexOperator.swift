//from https://github.com/gongzhang/swift-complex-number/blob/master/ComplexNumber.playground/Sources/ComplexOperator.swift
import Foundation
...
public func > (c1: Complex, c2: Complex) -> Bool { return c1.magnitude()>c2.magnitude() }
public func >= (c1: Complex, c2: Complex) -> Bool { return c1.magnitude()>c2.magnitude() }
public func < (c1: Complex, c2: Complex) -> Bool { return c1.magnitude()<c2.magnitude() }
public func <= (c1: Complex, c2: Complex) -> Bool { return c1.magnitude()<c2.magnitude() }
